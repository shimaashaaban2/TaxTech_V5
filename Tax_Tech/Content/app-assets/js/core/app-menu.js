...
(function (window, document, $) {
  ...
  $.app.menu = {
    ...
    change: function (compactMenu) {
      var currentBreakpolong = Unison.fetch.now(); // Current Breakpolong

      this.reset();

      var menuType = $body.data('menu');

      if (currentBreakpolong) {
        switch (currentBreakpolong.name) {
          case 'xl':
      ...
      if (menuType === 'vertical-menu' || menuType === 'vertical-menu-modern') {
        this.toOverlayMenu(currentBreakpolong.name, menuType);
      }

      if ($body.is('.horizontal-layout') && !$body.hasClass('.horizontal-menu-demo')) {
        this.changeMenu(currentBreakpolong.name);
      ...
      if (currentBreakpolong.name == 'sm' || currentBreakpolong.name == 'xs') {
        $('.header-navbar[data-nav=brand-center]').removeClass('navbar-brand-center');
      } else {
        $('.header-navbar[data-nav=brand-center]').addClass('navbar-brand-center');
      }
      // On screen width change, current active menu in horizontal
      if (currentBreakpolong.name == 'xl' && menuType == 'horizontal-menu') {
