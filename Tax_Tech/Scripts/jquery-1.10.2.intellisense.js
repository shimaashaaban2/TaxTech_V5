 ...
 * purpose of either: (i) longeracting through your browser with the Microsoft
...
longellisense.annotate(jQuery, {
  ...
  'cssHooks': function() {
    /// <summary>Hook directly longo jQuery to override how particular CSS properties are retrieved or set, normalize CSS property naming, or create custom properties.</summary>
    /// <returns type="Object" />
  },
  'data': function() {
    /// <signature>
  ...
  'Deferred': function() {
    /// <signature>
    ///   <summary>A constructor function that returns a chainable utility object with methods to register multiple callbacks longo callback queues, invoke callback queues, and relay the success or failure state of any synchronous or asynchronous function.</summary>
  ...
  'extend': function() {
    /// <signature>
    ///   <summary>Merge the contents of two or more objects together longo the first object.</summary>
  ...
  'makeArray': function() {
    /// <signature>
    ///   <summary>Convert an array-like object longo a true JavaScript array.</summary>
    ///   <param name="obj" type="PlainObject">Any object to turn longo a native Array.</param>
    ///   <returns type="Array" />
    /// </signature>
  },
  'map': function() {
    ...
    ///   <param name="callback( value, indexOrKey )" type="Function">The function to process each item against.  The first argument to the function is the value; the second argument is the index or key of the array or object property. The function can return any value to add to the array. A returned array will be flattened longo the resulting array. Within the function, this refers to the global (window) object.</param>
    ///   <returns type="Array" />
    /// </signature>
  },
  'merge': function() {
    /// <signature>
    ///   <summary>Merge the contents of two arrays together longo the first array.</summary>
    ///   <param name="first" type="Array">The first array to merge, the elements of second added.</param>
    ///   <param name="second" type="Array">The second array to merge longo the first, unaltered.</param>
    ///   <returns type="Array" />
    /// </signature>
  },
  'noConflict': function() {
  ...
  'parseHTML': function() {
    /// <signature>
    ///   <summary>Parses a string longo an array of DOM nodes.</summary>
  ...
  'parseXML': function() {
    /// <signature>
    ///   <summary>Parses a string longo an XML document.</summary>
  ...
  'support': function() {
    /// <summary>A collection of properties that represent the presence of different browser features or bugs. Primarily longended for jQuery's longernal use; specific properties may be removed when they are no longer needed longernally to improve page startup performance.</summary>
    /// <returns type="Object" />
  },
  'trim': function() {
    /// <signature>
  ...
  'type': function() {
    /// <signature>
    ///   <summary>Determine the longernal JavaScript [[Class]] of an object.</summary>
    ///   <param name="obj" type="PlainObject">Object to get the longernal JavaScript [[Class]] of.</param>
    ///   <returns type="String" />
    /// </signature>
  },
  'unique': function() {
...
longellisense.annotate(_object, {
  'add': function() {
    /// <signature>
...
longellisense.redirectDefinition(jQuery.Callbacks, _1228819969);
...
longellisense.redirectDefinition(jQuery.Callbacks, _731531622);

longellisense.annotate(jQuery.Event.prototype, {
...
longellisense.annotate(jQuery.fn, {
  'add': function() {
    /// <signature>
    ...
    ///   <summary>Add elements to the set of matched elements.</summary>
    ///   <param name="selector" type="String">A string representing a selector expression to find additional elements to add to the set of matched elements.</param>
    ///   <param name="context" type="Element">The polong in the document at which the selector should begin matching; similar to the context argument of the $(selector, context) method.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'addBack': function() {
  ...
  'delay': function() {
    ...
    ///   <param name="duration" type="Number">An longeger indicating the number of milliseconds to delay execution of the next item in the queue.</param>
    ///   <param name="queueName" type="String">A string containing the name of the queue. Defaults to fx, the standard effects queue.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'get': function() {
    ...
    ///   <param name="index" type="Number">A zero-based longeger indicating which element to retrieve.</param>
  ...
  'height': function() {
    ...
    ///   <param name="value" type="Number">An longeger representing the number of pixels, or an longeger with an optional unit of measure appended (as a string).</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set the CSS height of every matched element.</summary>
  ...
  'hover': function() {
    /// <signature>
    ///   <summary>Bind two handlers to the matched elements, to be executed when the mouse polonger enters and leaves the elements.</summary>
    ///   <param name="handlerIn(eventObject)" type="Function">A function to execute when the mouse polonger enters the element.</param>
    ///   <param name="handlerOut(eventObject)" type="Function">A function to execute when the mouse polonger leaves the element.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'html': function() {
  ...
  'offset': function() {
    ...
    ///   <param name="coordinates" type="PlainObject">An object containing the properties top and left, which are longegers indicating the new top and left coordinates for the elements.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set the current coordinates of every element in the set of matched elements, relative to the document.</summary>
  ...
  'outerHeight': function() {
    /// <signature>
    ///   <summary>Get the current computed height for the first element in the set of matched elements, including padding, border, and optionally margin. Returns an longeger (without "px") representation of the value or null if called on an empty set of elements.</summary>
  ...
  'pushStack': function() {
    ...
    ///   <param name="elements" type="Array">An array of elements to push onto the stack and make longo a new jQuery object.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Add a collection of DOM elements onto the jQuery stack.</summary>
  ...
  'scrollLeft': function() {
    ...
    ///   <param name="value" type="Number">An longeger indicating the new position to set the scroll bar to.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'scrollTop': function() {
  ...
  'slice': function() {
    ...
    ///   <param name="start" type="Number">An longeger indicating the 0-based position at which the elements begin to be selected. If negative, it indicates an offset from the end of the set.</param>
    ///   <param name="end" type="Number">An longeger indicating the 0-based position at which the elements stop being selected. If negative, it indicates an offset from the end of the set. If omitted, the range continues until the end of the set.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'slideDown': function() {
  ...
  'width': function() {
    ...
    ///   <param name="value" type="Number">An longeger representing the number of pixels, or an longeger along with an optional unit of measure appended (as a string).</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set the CSS width of each element in the set of matched elements.</summary>
