 ...
 *   https://datatables.net/download/#bs4/dt-1.10.22/b-1.6.5/b-print-1.6.5/sp-1.2.2
 *
 * Included libraries:
 *   DataTables 1.10.22, Buttons 1.6.5, Print view 1.6.5, SearchPanes 1.2.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.22/b-1.6.5/b-print-1.6.5/sp-1.2.2",
